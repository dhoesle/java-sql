...
```SQL
SELECT COUNT(order_id) as Orders, company_name
...
```SQL
SELECT COUNT(order_id) as orders, contact_name
FROM customers c JOIN orders o
on o.customer_id = c.customer_id
...
|  Owner Id  |  Pet Name  |  Pet Type  |Fenced Yard |City Dweller|            |            |            |            |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|
|     1      |  Ellie     |   Dog      |  no        |  Yes       |            |            |            |            |
|     2      |  Joe       |   Horse    |  no        |  No        |            |            |            |            |
|     3      |  Ginger    |   Dog      |  Yes       |  No        |            |            |            |            |
|     1      |  Tiger     |   Cat      |  no        |  Yes       |            |            |            |            |
|     3      | Miss Kitty |   Cat      |  yes       |  No        |            |            |            |            |
|     1      |  Toby      |   Turtle   |  no        |  Yes       |            |            |            |            |
